...
초기 실험과 달리, 최종 군집은 `주말 여부`로 완전히 갈라지지 않았습니다. 대신 짧은 이동 안에서도 **오전형 vs 저녁형**이 분리되고, 별도로 **장거리형**이 안정적으로 형성되어 실제 운영 패턴에 더 가깝게 해석할 수 있었습니다.
...
- **짧은 오전형 (32.9%)**: 오전 이동 수요가 몰리는 주거지·학군 인근 대여소의 08~10시 운영 안정화가 중요
