...
아래 예시는 실제 우선 대응 후보 중 하나인 `ST-1064`에 대해, STL이 원본 시계열을 `추세`, `계절성`, `잔차`로 어떻게 분해하는지 보여줍니다. README에서는 이 분해 결과 중 **잔차가 큰 시점**을 이상으로 간주해 운영적으로 해석했습니다.
...
아래 첫 번째 그림은 README의 핵심 결론인 `무슨 이상이 많았는지`와 `언제 집중됐는지`를 함께 보여줍니다. 두 번째 그림은 그중에서도 실제 운영 대응 가치가 큰 **평일 17~19시 급증이 어느 대여소에 반복되는지**를 바로 보여줍니다.
...
|---|---|---|---|---|---|
| **단거리 정기 이동형 - 저녁 집중** | 37.4% (18,676건) | 9.2분 | 1.18km | 8.7km/h | 17~18시 이용 집중 |
| **단거리 정기 이동형 - 오전 집중** | 32.9% (16,428건) | 8.3분 | 1.13km | 9.2km/h | 09시 전후 이용 집중 |
...
| 클러스터 | 피크 시간대 | 패턴 |
|---|---|---|
| 단거리 정기 이동형 - 저녁 집중 | 17~18시 | 퇴근 시간대 단거리 이용 집중 |
| 단거리 정기 이동형 - 오전 집중 | 08~10시 | 출근·통학 시간대 단거리 이용 집중 |
| 장거리형 | 14~16시 | 오후 장거리·여가성 이동 |
...
- **단거리 정기 이동형 - 저녁 집중 (37.4%)**: 주요 환승역·업무지구 인근 대여소의 17시 이전 재고 확보가 핵심. 퇴근 시간대 회전율 관리 대상
- **단거리 정기 이동형 - 오전 집중 (32.9%)**: 오전 이동 수요가 몰리는 주거지·학군 인근 대여소의 08~10시 운영 안정화가 중요. 출근·통학 대응 세그먼트로 해석 가능
